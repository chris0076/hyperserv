...
packettypes = ['CONNECT', 'SERVINFO', 'WELCOME', 'INITCLIENT', 'POS', 'TEXT', 'SOUND', 'CDIS', 'SHOOT', 'EXPLODE', 'SUICIDE', 'DIED', 'DAMAGE', 'HITPUSH', 'SHOTFX', 'EXPLODEFX', 'TRYSPAWN', 'SPAWNSTATE', 'SPAWN', 'FORCEDEATH', 'GUNSELECT', 'TAUNT', 'MAPCHANGE', 'MAPVOTE', 'ITEMSPAWN', 'ITEMPICKUP', 'ITEMACC', 'TELEPORT', 'JUMPPAD', 'PING', 'PONG', 'CLIENTPING', 'TIMEUP', 'MAPRELOAD', 'FORCEINTERMISSION', 'SERVMSG', 'ITEMLIST', 'RESUME', 'EDITMODE', 'EDITENT', 'EDITF', 'EDITT', 'EDITM', 'FLIP', 'COPY', 'PASTE', 'ROTATE', 'REPLACE', 'DELCUBE', 'REMIP', 'NEWMAP', 'GETMAP', 'SENDMAP', 'CLIPBOARD', 'EDITVAR', 'MASTERMODE', 'KICK', 'CLEARBANS', 'CURRENTMASTER', 'SPECTATOR', 'SETMASTER', 'SETTEAM', 'BASES', 'BASEINFO', 'BASESCORE', 'REPAMMO', 'BASEREGEN', 'ANNOUNCE', 'LISTDEMOS', 'SENDDEMOLIST', 'GETDEMO', 'SENDDEMO', 'DEMOPLAYBACK', 'RECORDDEMO', 'STOPDEMO', 'CLEARDEMOS', 'TAKEFLAG', 'RETURNFLAG', 'RESETFLAG', 'INVISFLAG', 'TRYDROPFLAG', 'DROPFLAG', 'SCOREFLAG', 'INITFLAGS', 'SAYTEAM', 'CLIENT', 'AUTHTRY', 'AUTHCHAL', 'AUTHANS', 'REQAUTH', 'PAUSEGAME', 'ADDBOT', 'DELBOT', 'INITAI', 'FROMAI', 'BOTLIMIT', 'BOTBALANCE', 'MAPCRC', 'CHECKMAPS', 'SWITCHNAME', 'SWITCHMODEL', 'SWITCHTEAM']